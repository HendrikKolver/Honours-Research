...
\iffalse
	...
	Already mentioned the definition in the intro so I am not really sure what sort of definition to put here
\fi
\hspace{0pt} \\
...
\end{itemize}
//TODO <All the terms that have not been defined yet in the paper that will be used in this section should be defined here, query if this is indeed a correct assumption>
